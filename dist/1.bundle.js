...
/***/ function(module, exports, __webpack_require__) {
	...
	* @requires ngSanitize
	*/
	exports['default'] = _angular2['default'].module('markdown', ['ngSanitize']).provider('markdown', _markdownProvider2['default']).directive('markdown', _markdownDirective2['default']).name;
	  ...
	  function link(scope, el, attrs) {
	    function render(val) {
	      ...
	      if (attrs.hasOwnProperty('mathjax')) {
	        _MathJax2['default'].Hub.Queue(['Typeset', _MathJax2['default'].Hub, el[0]]);
	      }
	    }
