...
/***/ function(module, exports) {
	...
	module.exports = {
		"Technik / Ingenieur / Naturwissenschaften / Bau / Chemie": [
			...
			"Angewandte Informatik ( Ingenieur/Medieninformatik)",
			...
			"Cognitive Science",
			"Computergestütze Ingenieurwissenschaften",
			...
			"Biomaterials",
			"Biologie",
			"Bioverfahrenstechnik in Agrarwirtschaft und Lebensmittelwirtschaft",
			"Biotechnik",
			"Apparative Biotechnologie",
			"Bionik",
			"Molekulare/angewandte Biotechnologie",
			"Biowissenschaften",
			"Neurowissenschaften",
			"Molekularbiologie",
			...
			"Technomathematik",
			"Technomathematik (Elektrotechnik)",
			"Technomathematik (Maschinenbau)",
			"Elementarmathematik",
			"Physik",
			...
			"Wirtschaftsingenieurwesen ( Werkstoff/Prozesstechnik)",
			"Wirtschaftsingnieurwesen / Facility Management",
			"Wirtschaftsingenieurwesen / Transport, Verkehr und Logistik",
			"Wirtschaftsingenieurwesen – Physikalische Technologien",
			"Wirtschaftsingenieurwesen:Gebäudesystemtechnik",
			"Wirtschaftsingenieurwesen – Energie/Gebäude/Umwelttechnik",
		...
		"Soziales / Erziehungswissenschaften / Pflege / Pädagogik": [
			"Erziehungswissenschaft",
			"Ökonomische Bildung",
			"Sozialwissenschaften",
			"Inegrierte Sozialwissenschaften",
			...
			"Theaterpädagogik",
			"Sozialpolitik",
			"Regionalstudien China: Sozialwissenschaft",
			"Regionalstudien Lateinamerika: Sozialwissenschaften",
			"Regionalstudien Ost-und Mitteleuropa: Sozialwissenschaften",
			"Regionalstudien Ost-und Mitteleuropa: Sozialwissenschaften",
			"Sozialarbeit/Sozialpädagogik",
			"Pädagogik der Kindheit und Familienbetreuung",
			...
			"Psychische Gesundheit / Psychatrische Pflege",
			"Gerontologie",
			"Darstellendes Spiel"
		],
		"Wirtschaft / Handel / Management / Ökonomie": [
			...
			"Wirtschaftslehre/Politk",
			"International Business Studies",
			"International Studies in Management",
			"International Business Law an Business Management",
			...
			"Regionalstudien China: Volkswirtschaftslehre",
			"Regionalstudien Lateinamerika: Volkswirtschaftslehre",
			"Regionalstudien Ost-und Mitteleuropa: Volkswirtschaftslehre",
			"Sales Engineering and Product Management",
			"BWL/ Business Administation",
			...
			"Schiffs-und Redereimanagement",
			"Technical Management",
			"Sozial-und Gesundheitsmanagement"
		],
		"Kultur / Politikwissenschaften / Gesellschaft": [
			"Kultur, Individuum und Gesellschaft",
			"Archäologie",
			"Archäologie der Klassischen und Byzantinischen Welt",
			"Antike Kulturen",
			"Kulturanthopologie – Europäische Ethnologie",
			"Kulturen und Gesellschaft Asiens: Indienstudien",
			...
			"Ethnologie",
			"Kulturen und Gesellschaft Asiens: Chinastudien",
			"Kulturen und Gesellschaft Asiens: Japanstudien",
			"Asienwissenschaften",
			"Ostasienwissenschaften",
			"Modernes Japan",
			"Altamerikanistik/Ethnologie",
		...
		"Sprachen / Literatur / Buchwesen": [
			...
			"Deutsche Sprache und Kultur /Literatur",
			"Japanologie",
			...
			"Skandinavistik",
			"Iranistik",
			"Skandinavik/Fennistik",
			"Klinische Linguistik",
			"Texttechnologien und Computerlinguistik",
			"Europäische Rechtslinguistik",
			"Fennistik ( Finnisch)",
			"Linguistik und Phonetik",
			"Griechische und Lateinische Literaturen",
			"Hispanistik",
			"Indologie",
			"Allgemeine Sprachwissenschaft",
			...
			"Komparatistik",
			"Bibliothekswesen",
			"Sprachen und Wirtschaft (FRA/ENG)",
			"Sprachen und Wirtschaft (SPA/FRA)",
			"Sprachen und Wirtschaft (SPA/ENG)",
			"Banking and Finance",
			"International Business",
			"Versicherungswesen"
		],
		"Musik / Tanz / Theater / Kunst / Film": [
			"Kunstgeschichte",
			...
			"Dirigieren",
			"Evangelische / katholische Kirchenmusik",
			"Musikübertragung",
			"Komposition",
			"Musiktheorie und Gehörbildung"
		],
		"Medien / Kommunikation / Gestaltung / Information": [
			"Medienwissenschaft",
			"Public Relations",
			...
			"Kreatives Schreiben & Kulturjournalismus",
			"Textilgestaltung",
			...
			"Farbtechnik/Tauchgestaltung/Oberflächentechnik",
			"Industrial Design",
			"Produktdesign",
			"Communication and Multimedia Design",
			"Kommunikationsdesign",
			"Mode-Textil-Design",
			"Applied Art an Design",
			"Mediendesign und Designtechnik",
			"Medienmanagement  -",
			"Gestaltungstechnik",
			"Literatur, Kultur, Medien",
			"Sprache und Kommunikation",
			"Medienkulturwissenschaft: Medieninformatik",
			"Medienkulturwissenschaft: Medienpsychologie",
			"Medienkulturwissenschaft: Medienmanagement",
			"Medienkulturwissenschaft: Medienrecht",
			"Medienkulturwissenschaft: Ökonomie und Soziologie der Medien",
		...
		"Umwelt / Ressourcen / Energie / Naturschutz / Klima": [
			"Umwelttechnik und Ressourcen-Management",
			"Environmental and Susteinability Studies",
			"Geographie",
			"Umweltsicherung",
			"Geowissenschaften",
			...
			"Agrarwirtschaft",
			"Fortswissenschaften und Waldökologie",
			"Molecular Ecosystem Science",
			...
			"Energieeffizienz",
			"Nachhaltigkeithumanwissenschaften",
		...
		"Sport / Ernährung / Hauswirtschaft / Gesundheit": [
			"Sportwissenschaft",
			"Sport",
		...
		"Medizin / Pharmazie / Medizintechnik": [
			...
			"Molekulare Medizin",
			"Medizinische Physik",
			"Mathematik in Medizin und Lebensmittelwissenschaften",
		...
		"Religion / Philosophie": [
			...
			"Christliche Studien",
			"Islamistische Religionslehre",
			"Islamistische Theologie",
			"Ehtik",
			"Komparative Theologie der Religionen",
			"Christliche Theologien in ökumenischer Perspektive",
			"Religion im europäischen Kontext",
			"Evangelische Theologie und Hermeneutik",
			"Vergleichende Religionswissenschaft"
		],
		"Rechtswissenschaften / Psychologie": [
			"Psychologie",
			"Psychologie: Schwerpunkt Pädagogik",
			"Rechtswissenschaft",
			"Rechtswissenschaften – Unternehmens- und Wirtschaftsrecht",
			"IT – Recht und Recht geistigen Eigentums",
			...
			"Jura",
			"Regionalstudien China: Rechtswissenschaft",
			"Regionalstudien Ost-und Mitteleuropa: Rechtswissenschaften Ostrecht",
